-- 000_master.sql
-- Purpose: One-shot Supabase SQL Editor script for the complete VerifiedSocial schema setup
-- Execution order: 001_initial_schema.sql then 002_add_indexes.sql
-- How to run: Copy/paste this entire file into Supabase SQL Editor and run once
-- Rollback: See rollback sections in the numbered files
